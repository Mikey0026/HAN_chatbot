...
def load_pdfs(raw_dir: Path) -> List[Document]:
    """
    Load PDFs page-by-page using PyPDFLoader.

    Each PDF page becomes a LangChain Document with page metadata,
    which allows accurate source tracing in the chatbot.
    """
    ...
    for pdf_path in pdf_paths:
        ...
        for page in pages:
            ...
            page.metadata["source_type"] = "manual"
